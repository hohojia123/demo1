<template>
  <el-card id="account">
    ...
    <div id="updateAvatar">
      <div>
        ...
        <el-form ref="form" label-width="100px">
          <el-form-item label="当前头像">
            <img v-if="userAvatar!==''" :src="userAvatar" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 1px solid #ddd;">
            <i v-else class="el-icon-user-solid" style="font-size: 100px; color: #ddd;"></i>
          </el-form-item>
      ...
      <div style="margin-left: 45%">
        <el-button icon="el-icon-picture" @click="updateAvatar()">更新头像</el-button>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      updateAvatar() {
        ...
        user.updateAvatar(this.imageUrl).then(res => {
          this.$message({
            message: res.message,
            type: 'success'
          });
      ...
      sendMail(mail) {
        ...
        user.sendMail(mail).then(res => {
          _this.$message.success('验证码已发送，请注意查收');
