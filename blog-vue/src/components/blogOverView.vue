    ...
    <div @mouseenter="pEnter()" @mouseleave="pLeave()">
      <p style="overflow: hidden;text-overflow:ellipsis; white-space: nowrap;">
        ...
        <span class="el-icon-user-solid hidden-xs-only" style="width: 10%;text-align: center;">
          <img v-if="avatar" :src="avatar" style="width: 20px; height: 20px; border-radius: 50%; vertical-align: middle; margin-right: 5px; object-fit: cover;">
          &nbsp;{{name}}
        </span>
...
<script>
  ...
  export default {
    name: 'blogOverView',
    props: ['id', 'title', 'body', 'time', 'blogViews', 'discussCount', 'tags', 'name', 'avatar'],
    data() {
      return {
        show: false
      }
